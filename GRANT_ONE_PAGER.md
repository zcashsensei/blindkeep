...
**Automated suite (2026-08-11):** **621 tests** across 38 suites + end-to-end demo. Counts are computed from source by `oblivio status`, and `tools/check_counts.py` blocks a push that would leave this line stale:
...
|-------|-------------|--------|
| **M0** | Public MIT repo, docs, 621 tests | **done** |
