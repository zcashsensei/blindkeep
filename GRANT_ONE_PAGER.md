...
| ZK proofs of properties without disclosure (range, membership, equality) | `zk.py`, 31 tests (`blindkeep prove` / `verify-proof`) |
...
**Automated suite (2026-08-07):** **310 tests** across 19 suites + end-to-end demo — Merkle 13 · store 5 · metadata 8 · adversarial 9 · replication 12 · recovery 21 · hardening 12 · discovery 18 · audit 10 · local-model memory 13 · cloud gate 13 · CLI 15 · console 8 · vault proxy 30 · attestation 30 · memory gate 29 · SEV-SNP 19 · status 14 · zk 31.
...
|-------|-------------|--------|
| **M0** | Public MIT repo, docs, 310 tests | **done** |
