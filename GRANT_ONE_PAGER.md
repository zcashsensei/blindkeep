...
| **Anonymous entitlement**: Chaum blind signatures — prove you may ask without saying who you are (the construction underneath RFC 9578, not the standardised RSABSSA of RFC 9474) | `anon_token.py`, 24 tests |
...
**Automated suite (2026-08-11):** **588 tests** across 36 suites + end-to-end demo. Counts are computed from source by `blindkeep status`, and `tools/check_counts.py` blocks a push that would leave this line stale:
...
|-------|-------------|--------|
| **M0** | Public MIT repo, docs, 588 tests | **done** |
