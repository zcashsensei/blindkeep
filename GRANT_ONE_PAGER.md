...
**Automated suite (2026-08-11):** **541 tests** across 33 suites + end-to-end demo. Counts are computed from source by `blindkeep status`, and `tools/check_counts.py` blocks a push that would leave this line stale:
...
|-------|-------------|--------|
| **M0** | Public MIT repo, docs, 541 tests | **done** |
