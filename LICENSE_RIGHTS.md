...
- Credible for public-good / grant-funded privacy infrastructure  
- Simple for contributors and operators  
- Compatible with a free self-host path and an optional paid capacity tier on a network the project operates  
...
Fees attach to **operated capacity and services**, not to reading or running the open-source code.
...
|-------|--------|
| Source license | MIT |
| “All rights” meaning | Copyright + brand + right to commercialize — **not** exclusive monopoly on forks |
| End users | Free self-host; free public quota when a public mesh exists |
| Project business | Hosted mesh, brand, optional micropay, support contracts |
| Fake “MIT but only we may commercialize” | Rejected |

For strategy and grant milestones, see [`PATH_TO_MASSES.md`](PATH_TO_MASSES.md).  
For product category and privacy doctrine, see [`THESIS.md`](THESIS.md).
